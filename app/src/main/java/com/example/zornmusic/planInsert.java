...
public class planInsert extends AppCompatActivity {
    //uPlan(PlanName,Image,amount,noOfSongsDownload)
    DatabaseHandler dbHandler;
    SQLiteDatabase sqLiteDatabase;
    EditText name,amount,downloadLimit;
    ...
    private void insertData(){
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                values.put(UserMasters.UserPlans.COLUMN2_IM,ImageViewToByte(imagePlan));
                values.put(UserMasters.UserPlans.COLUMN1_PN,name.getText().toString());
                values.put(UserMasters.UserPlans.COLUMN3_AM,amount.getText().toString());
                values.put(UserMasters.UserPlans.COLUMN4_DL,downloadLimit.getText().toString());
                sqLiteDatabase=dbHandler.getWritableDatabase();
                Long recordInsert = sqLiteDatabase.insert(UserMasters.UserPlans.TABLE_NAME1,null,values);
                if(recordInsert==-1){
                    Toast.makeText(planInsert.this, "Not inserted successfully", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(planInsert.this, "Inserted successfully", Toast.LENGTH_SHORT).show();
        ...
        display.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(),viewPlans.class));
            }
        });
    }
